...
description: |
  This post will be looking at Chart 6 Resident labour force by age in MOM's [Report: Labour Force in Singapore 2019](https://stats.mom.gov.sg/Pages/Labour-Force-In-Singapore-2019.aspx) and seeing if there are possible areas for improvement.
preview: posts/2021-01-22-dataviz-makeover-1/images/13.%20Final%20Dashboard.png
author:
  - name: Amos Lau
...
The proposed data visualisation can be found at...

## Step-by-step Description

> d.  Provide step-by-step description on how the data visualisation was prepared.

The following are sections describe how the data visualisation was prepared.
...
Using the proposed data visualisation...
